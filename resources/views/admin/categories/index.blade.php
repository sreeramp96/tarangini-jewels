...
@section('content')
<div class="flex justify-between items-center mb-6 hero-text ">
    <h1 class="text-3xl font-semibold text-gray-200">Categories</h1>
    <a href="{{ route('admin.categories.create') }}"
        class="px-6 py-2 rounded text-gray font-medium btn-gold glow-hover">
        Add New Category
    </a>
</div>
...
<div class="bg-white rounded-lg shadow-md overflow-hidden hero-text">
