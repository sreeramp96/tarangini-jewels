...
@section('content')
    ...
    <div class="bg-[#0d4837] border border-brand-gold/40 p-8 rounded-lg shadow-md max-w-2xl">
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="4"
                    class="block w-full mt-1 border-gray-300 focus:border-yellow-500 focus:ring-yellow-500 rounded-md shadow-xs">{{ old('description', $category->description) }}</textarea>
            ...
            <div class="mt-6 flex items-center space-x-4">
                ...
                <a href="{{ route('admin.categories.index') }}"
                    class="px-8 py-3 rounded-sm text-white font-medium btn-red glow-hover">
                    Cancel
                </a>
            </div>
        </form>
