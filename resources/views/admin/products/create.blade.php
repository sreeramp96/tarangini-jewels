...
@section('content')
    ...
    <div x-data="{ activeTab: 'manual' }" class="max-w-4xl">
        <div class="mb-4 border-b border-brand-gold/40">
        ...
        <div>
            <div x-show="activeTab === 'manual'" x-transition>
                <div class="bg-[#0d4837] border border-brand-gold/40 p-8 rounded-lg shadow-md">
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="category" name="category_id" class="block w-full mt-1 border-gray-300 focus:border-yellow-500 focus:ring-yellow-500 rounded-md shadow-xs text-gray-700">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="description" name="description" rows="6" class="block w-full mt-1 border-gray-300 focus:border-yellow-500 focus:ring-yellow-500 rounded-md shadow-xs">{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="mb-6">
                                    <label for="is_featured" class="inline-flex items-center">
                                        <input id="is_featured" type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="rounded-sm border-gray-300 text-yellow-600 shadow-xs focus:ring-yellow-500">
                        ...
                        <div class="mt-6 flex items-center space-x-4">
                            <button type="submit" class="px-8 py-3 rounded-sm text-white font-medium btn-gold glow-hover">
                                Save Product
                            </button>
                             <a href="{{ route('admin.products.index') }}" class="px-8 py-3 rounded-sm text-white font-medium bg-red-600 hover:bg-red-700 transition">
                                Cancel
                            </a>
                        </div>
                    </form>
            ...
            <div x-show="activeTab === 'upload'" style="display: none;" x-transition>
                <div class="bg-[#0d4837] border border-brand-gold/40 p-8 rounded-lg shadow-md">
                    <form action="{{ route('admin.products.import.handle') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6 p-4 bg-[#0a2e2b] rounded-sm border border-gray-600 text-gray-300 text-sm space-y-2">
