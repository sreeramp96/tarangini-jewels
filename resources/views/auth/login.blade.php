            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="block mt-4">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox"
                            class="rounded-sm border-gray-300 text-amber-600 shadow-xs focus:ring-amber-500" name="remember">
                ...
                <div class="flex items-center justify-end mt-6">
                    @if (Route::has('password.request'))
                        <a class="underline text-sm text-amber-700 hover:text-amber-900 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
