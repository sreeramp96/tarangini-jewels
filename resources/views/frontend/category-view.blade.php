...
@section('content')
    <main class="bg-white py-12 px-4 lg:px-12">
        <div class="text-center mb-12">
            <h1 class="text-4xl lg:text-5xl font-bold hero-text text-gray-800">{{ $category->name }}</h1>
            <p class="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto mt-4">{{ $category->description }}</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        @empty
                            <div class="col-span-full text-center py-12">
                                ...
                                <a href="{{ url()->current() }}" class="text-brand-gold hover:underline mt-2 inline-block">Clear all filters</a>
                            </div>
                        @endforelse
                    </div>
