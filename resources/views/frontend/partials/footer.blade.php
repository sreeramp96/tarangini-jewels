        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            {{-- <div>
                ...
                <nav class="flex flex-col space-y-3">
                    ...
                    <a href="#" class="text-gray-400 hover:text-brand-gold hover:translate-x-1 transition-all duration-300">Earrings</a>
                    <a href="#" class="text-gray-400 hover:text-brand-gold hover:translate-x-1 transition-all duration-300">Bracelets</a>
                    <a href="#" class="text-gray-400 hover:text-brand-gold hover:translate-x-1 transition-all duration-300">Bridal Sets</a>
                </nav>
            </div>
            ...
            <div>
                ...
                <nav class="flex flex-col space-y-3">
                    <a href="#" class="text-gray-400 hover:text-brand-gold hover:translate-x-1 transition-all duration-300">About Us</a>
                    <a href="#" class="text-gray-400 hover:text-brand-gold hover:translate-x-1 transition-all duration-300">Privacy Policy</a>
                    <a href="#" class="text-gray-400 hover:text-brand-gold hover:translate-x-1 transition-all duration-300">Terms & Conditions</a>
    ...
    {{-- <div class="bg-black/20 py-6 border-t border-brand-gold/10">
        <div class="max-w-7xl mx-auto px-6 lg:px-20 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-4 mt-4 md:mt-0">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/1200px-MasterCard_Logo.svg.png" alt="Mastercard" class="h-6 opacity-50 grayscale hover:grayscale-0 transition">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/1200px-Visa_Inc._logo.svg.png" alt="Visa" class="h-6 opacity-50 grayscale hover:grayscale-0 transition">
            </div>
        </div>
    </div> --}}
</footer>
