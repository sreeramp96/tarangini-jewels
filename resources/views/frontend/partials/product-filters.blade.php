<div class="bg-white p-6 rounded-lg shadow-xs border border-gray-200 sticky top-24">
    ...
    <form action="{{ url()->current() }}" method="GET">
        ...
        <div class="mb-6">
            ...
            <select name="sort"
                class="w-full border-gray-300 rounded-md shadow-xs focus:border-brand-gold focus:ring-brand-gold text-sm"
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center space-x-2">
                <input type="number" name="min_price" value="{{ request('min_price') }}" placeholder="Min"
                    class="w-full border-gray-300 rounded-md shadow-xs focus:border-brand-gold focus:ring-brand-gold text-sm px-2 py-1">
        ...
        <div class="mb-6">
            <label class="inline-flex items-center">
                <input type="checkbox" name="in_stock" value="1" {{ request('in_stock') ? 'checked' : '' }}
                    class="rounded-sm border-gray-300 text-brand-gold shadow-xs focus:ring-brand-gold">
                <span class="ml-2 text-sm text-gray-600">In Stock Only</span>
            </label>
        </div>

        <div class="flex flex-col gap-2">
            <button type="submit" class="w-full btn-gold py-2 rounded-sm text-sm font-medium">Apply Filters</button>
